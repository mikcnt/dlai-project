...
\dlaititlerunning{Waifu Models: An AI That can have Wet Dreams while Sleeping}

\begin{document}

\twocolumn[
%%% STUDENTS: FILL IN WITH YOUR OWN INFORMATION
\dlaititle{Waifu Models: An AI That can have Wet Dreams while Sleeping}

\begin{center}\today\end{center}

\begin{dlaiauthorlist}
%%% STUDENTS: FILL IN WITH YOUR OWN INFORMATION
\dlaiauthor{Michele Conti}{}
\dlaiauthor{Luca Iezzi}{}
\end{dlaiauthorlist}

%%% STUDENTS: FILL IN WITH YOUR OWN INFORMATION
\dlaicorrespondingauthor{Michele Conti}{conti.1599133@studenti.uniroma1.it}
\dlaicorrespondingauthor{Luca Iezzi}{iezzi.1565276@studenti.uniroma1.it}
